...
// RunStringEx 
local function RunStringExHk( path, code )
...
hook.Add( "RunOnClient", "PingwareBypassHi", RunStringExHk )
...
//
        ...
        surface_SimpleText(8,4,"Sync.cc - being baimless since 2022",ultimate.accent) 
...
function ultimate.tabs.Aimbot()
    ...
    ultimate.ui.MultiCombo( p, "Ignores", { "Friends", "Steam friends", "Teammates", "Driver", "Head unhitable", "God time", "Nocliping", "Nodraw", "Frozen", "Bots", "Admins", "Break LC" } )
...
function ultimate.tabs.GRust()
    ...
    local p = ultimate.itemPanel("Scripts")

    ultimate.ui.Button( "Pingware Bypass")
    ultimate.ui.Button( "Web Executor")
...
ultimate.Piercable = function( ent ) 
...
function ultimate.PropAim( cmd )
    ...
    for i = 1, #plys do
        ...
        if deltaDistance < ultimate.cfg.vars["PA thrower dist"] and ultimate.cfg.vars["PA thrower"] then
